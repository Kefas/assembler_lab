...
# otworzyc plik do czytania
# wypisac cos na ekran
# zakmnac plik
...
buffer:				# buffer for file data
	.space		128, 0
	#wszystkie bity w pamieci od tego miejsca +128 sa ustawione na 0
...
#petla:
#zeby to zrobic trzeba pozmieniac kolejnosc operacji
#1. trzeba wypisywanie komunikatu o files contains trzeba przerzucic gdzies do gory (na sam poczatek
#2. zamykanie pliku i kontrola na dó³
	...
	#to cale trzeba przepchnac o jeden blok w dol (za operacje wypisywania)
	MOVL	b_read,%eax
	CMPL	bufsize,%eax	# whole file was read ?
	JE	toobig		# wystarczy jump if equal
